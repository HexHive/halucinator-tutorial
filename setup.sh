...
UBUNTU_DEPS="gcc build-essential pkg-config gdb-multiarch virtualenv python3-pip python3-virtualenv libcap-dev libpixman-1-dev libglib2.0-dev python3-ipdb"
